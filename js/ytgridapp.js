...
ytsubgridApp.controller('AppCtrl', function($rootScope, appLoading) {
...
ytsubgridApp.controller('AppHomeCtrl', function($scope, appLoading) {
	appLoading.ready();
});

ytsubgridApp.controller('AppRepeatCtrl', function($scope, $store, ytSubList, appLoading, $timeout) {
...
ytsubgridApp.factory('appLoading', function($rootScope) {
	var timer;
	return {
		loading : function() {
			clearTimeout(timer);
...
ytsubgridApp.factory('ytSubList', function($rootScope, $http, $q) {
...
ytsubgridApp.directive('scroll', function($window, $document) {
...
ytsubgridApp.directive('jqIcheck', function(){
...
ytsubgridApp.filter('duration', function() {
	return function(d) {
		d = Number(d);
...
ytsubgridApp.filter('visible', function() {
